...
export default function FormEditCustomer(props :{id :any }) {
  ...
  const onSubmit = (data: AdmEditDto) => {
  ...
  const ProfileSection = () => (
    <section className="profileSection">
      ...
      <div>
        <p className="personName">{adm?.name || "Carregando..."}</p>
    ...
    <Modal
      ...
      content={
        <div className="containerModal">
          <h1 className="titleModal">DESEJA EDITAR O ADMINISTRADOR?</h1>
