...
export default function ModalConfirmationPassword() {
            ...
            return(
                <div className='containerModalEmailConfirmation'>
                    ...
                    <div className='subContainerModalEmailConfirmation'>
                        <h2 className='titleModalEmailConfirmation'> Alteração de Celular</h2>
                        <div className='lineModalEmailConfirmation'>  </div>
                        <div className='textModalEmailConfirmation'> Um código de confirmação será enviado para este telefone para validá-lo </div>
                    </div>
                    <div className='inputModalEmailConfirmation'>  
                        <InputText name="name" size="large" id="user" text="Celular" placeholder="Digite o  celular"/>
                    </div>
        ...
        if(page==1){
            ...
            return(
                ...
                <div className='subContainerModalEmailConfirmation'>
                    ...
                    <div className='lineModalEmailConfirmation'>  </div>
                    <div className='textModalEmailConfirmationSecond'> Verifique se há um código de verificação para 8479****  <a className='mudarModalEmail'> Mudar </a> </div>
                </div>
                <div className='inputModalEmailConfirmation'>  
                    <InputText name="name" size="large" id="user" text="Código de 6 dígitos" placeholder="Digite o código"/>
                </div>
