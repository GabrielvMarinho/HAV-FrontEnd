                ...
                <article className="articleDataForm">
                    ...
                    <div className="inputArticle">
                        ...
                        <InputText
                            ...
                            register={form.register}
                            error={form.formState.errors[textFields.email.name as keyof NewCustomer]}
                        />
                        <InputText
                        ...
                        <InputDropdown
                            ...
                            register={form.register}
                            error={form.formState.errors[dropdownFields.city.name as keyof NewCustomer]}
                        />
                        <InputDropdown
                            ...
                            register={form.register}
                            error={form.formState.errors[dropdownFields.state.name as keyof NewCustomer]}
                        />
                        <InputDropdown
